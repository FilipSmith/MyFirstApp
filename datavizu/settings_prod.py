"""
Django settings for datavizu project.
...
SECRET_KEY = 'eju%pq0d4#9oyyduzne+%wvo4c7yvb+ab5*3@z9m2o9yk=of7k'
...
STATICFILES_DIRS = (
        os.path.join(PROJECT_ROOT, 'coffeestatic'),
    )
