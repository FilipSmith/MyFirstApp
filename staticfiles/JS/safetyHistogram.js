(function(global, factory) {
        ...
        marks: [
            {
                ...
                summarizeY: 'count',
                summarizeX: 'mean',
                attributes: { 'fill-opacity': 0.55 ,'fill': 'red' ,'stroke':'blue'}
            }
        ],
        aspect: 3
    };
    ...
    function syncSettings(settings) {
        ...
        defaultDetails.push({ value_col: settings.visit_coln, label: 'Visit num.' });
	    defaultDetails.push({ value_col: settings.visit_col, label: 'Visit' });
    ...
    function updateXaxisResetButton() {
        ...
        if (this.currentMeasure !== this.previousMeasure)
            this.controls.wrap.selectAll('.x-axis').property(
                    'title',
                    'Initial Limits: [' +
