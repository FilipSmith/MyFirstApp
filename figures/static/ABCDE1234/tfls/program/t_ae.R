...
####################Import SAS data###############
library(sas7bdat)
dataset<-"AE"    ####dataset=AE.sas7bdat
study<-"ABCDE1234"    ####dataset=AE.sas7bdat
title<-"Treatment-Emergent AEs"    ####dataset=AE.sas7bdat
footnote<-"1"    ####dataset=AE.sas7bdat
population<-"Safety Population"    ####dataset=AE.sas7bdat
type<-"Table" 
number<-"11.1" 

path<-"C:/Users/Felipe/Documents/django"
filesas<-paste(path,"/study/static/",study,"/tfls/",dataset,".sas7bdat",sep="")
