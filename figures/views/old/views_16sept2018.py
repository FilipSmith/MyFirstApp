...
def getData(request , doc_id):
    ...
    return render(request, 'figures/getData.html', { 'document':doc , 'dataset':dataset, 'graph_list':graph_list , 'check_list':check_list,'variables':variables, 'flag_list':flag_list})   
